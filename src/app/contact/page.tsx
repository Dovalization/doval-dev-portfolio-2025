    ...
    <div className="min-h-screen bg-dark-primary text-light-primary py-20 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto">
        <MetaSection
          ...
          subtitle="I'm always interested in discussing new projects, creative ideas, or opportunities to be part of your vision."
        />
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-orange-primary pl-6 bg-dark-secondary p-4 rounded-r-lg">
                  <h3 className="font-semibold text-lg mb-2 text-light-primary">
                    {`Product Engineering Roles`}
                  </h3>
                  <p className="text-gray-light">
                    {`Full-stack positions where I can shape both user experience
                ...
                <div className="border-l-4 border-orange-primary pl-6 bg-dark-secondary p-4 rounded-r-lg">
                  ...
                  <p className="text-gray-light">
                    {`Design system development, technical architecture, and user
                ...
                <div className="border-l-4 border-orange-primary pl-6 bg-dark-secondary p-4 rounded-r-lg">
                  ...
                  <p className="text-gray-light">
                    {`Open source projects, speaking engagements, and knowledge
                    sharing initiatives.`}
                  </p>
                </div>
              </div>
