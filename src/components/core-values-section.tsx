      ...
      {coreValues.map((valueEntry, index) => {
        ...
        return (
          <div
            key={index}
            className={cn(
              "from-dark-secondary to-gray-medium border-gray-medium/20 group relative flex flex-col items-center gap-2 rounded-2xl border bg-gradient-to-br px-4 py-6 pt-12 text-center shadow-2xl transition-all duration-250 ease-in-out text-shadow-sm hover:scale-105 hover:shadow-2xl",
              {
