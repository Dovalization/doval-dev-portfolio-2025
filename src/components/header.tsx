        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-3">
            <a
              ...
              className="w-10 h-10 bg-orange-secondary rounded-full flex items-center justify-center hover:bg-orange-primary transition-colors"
            >
              <svg
                className="w-5 h-5 text-dark-primary"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
